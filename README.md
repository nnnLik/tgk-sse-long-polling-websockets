...
4. [О Websocket-аaхххх](#websocket)
5. [Links](#links)
...
<!-- Один из способов решение проблемы авторизации заключается в использовании токена
Есть много способов решения проблемы авторизации в Websocket и SSE. Желание писать книгу у меня нет и практического опыта в этом тоже. Есть доклад который рассказывает о решениии этой проблемы и  -->
...
### Видосы
* [Аутентификация для WebSocket до сих пор нет стандарта](https://www.youtube.com/watch?v=n9mRjkQg3VE&ab_channel=FestGroup)
